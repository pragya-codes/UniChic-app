		...
		<>
			<div className="container" style={{ height: '100vh' }}>
				<div className="about">
					<h2>ABOUT US.</h2>
					<p>
						Avira caters to thoughtful shoppers who appreciate
						unique designs and top quality pieces you just can’t
						find elsewhere. We are constantly curating fresh new
						collections and looking for the next big thing our
						customers will love. Founded in Vienna in 2019, we are
